...
| ---------------|:----------------------------------|:---------------:|
| 18             | Calculator                        |`Done`           |
| 19             | Countdown Clock and Timer         |`Done`           |
| 20             | Random Password Generator         |                 |
| 21             | Random Wikipedia Article          |`Done`           |
| 22             | Reddit Bot                        |`In_Progress`    |
...
| Proj No.       | Project Name                                    | Status          |
| ---------------|:------------------------------------------------|:---------------:|
| 31             | Speed Typing Test                               |`Done`           |
| 32             | Content Aggregator                              |`Done`           |
| 33             | Bulk File Rename/ Image Resize Application      |                 |
| 34             | Python File Explorer                            |`Done`           |
| 35             | Plagiarism Checker                              |`In_Progress`    |
| 36             | Web Crawler                                     |                 |
| 37             | Music Player                                    |                 |
